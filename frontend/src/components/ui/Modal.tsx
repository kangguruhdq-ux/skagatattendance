  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      <div
        ...
        aria-modal="true"
        className={clsx(
          "relative w-full rounded-2xl bg-slate-900 border border-slate-700/80 shadow-2xl shadow-black/60",
          "transform transition-all duration-200 z-10 my-auto text-slate-100 overflow-hidden",
          sizeMap[size]
        )}
      >
